...
public abstract class MAbstractTexture implements VAbstractTextureI {
    ...
    public VulkanImage getVulkanImage() {
        if (this.vulkanImage != null)
            ...
            final net.vulkanmod.gl.VkGlTexture glTexture = net.vulkanmod.gl.VkGlTexture.getTexture(this.id);
            if (glTexture != null)
    ...
    public void setVulkanImage(VulkanImage image) {
        ...
        if (this.id == -1)
            this.getId();
        net.vulkanmod.gl.VkGlTexture.setVulkanImage(this.id, this.vulkanImage);
    }
}
