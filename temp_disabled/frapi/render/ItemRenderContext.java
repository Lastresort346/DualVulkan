...
public class ItemRenderContext extends AbstractRenderContext {
	...
	public void renderModel(ItemDisplayContext itemDisplayContext, PoseStack matrixStack, MultiBufferSource bufferSource, int lightmap, int overlay, int[] tints, List<BakedQuad> modelQuads, MeshView mesh, RenderType renderType, FoilType foilType, boolean ignoreQuadGlint) {
    ...
    private VertexConsumer getVertexConsumer(@Nullable RenderType quadRenderLayer, @Nullable FoilType quadGlint) {
        RenderType layer;
        FoilType glint;
	...
	private VertexConsumer createVertexConsumer(RenderType layer, FoilType glint) {
		...
		return ItemRenderer.getFoilBuffer(vertexConsumerProvider, layer, true, glint != FoilType.NONE);
	}
